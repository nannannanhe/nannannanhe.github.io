...
### SENDAI is our playground.

![banner](./archive/siop_v1/img/title_600_20190317.png)

A personal project originally built to collect and share live music event information in Sendai, Japan.  
The project evolved over time as the live music environment and my available time changed.
...
- This rebuild was motivated by limited time to maintain automated crawlers and the impact of COVID-19, which significantly reduced live house events while increasing online streaming concerts.
- Tech stack: HTML, CSS, JavaScript, MySQL, WordPress
